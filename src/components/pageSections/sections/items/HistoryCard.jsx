  ...
  return (
    <div className="group relative">
      <span className="absolute top-2 start-0 w-4 h-4 translate-x-1/2 rounded-full bg-primary transition-all duration-750 z-10">
        <span className="absolute top-1/2 start-1/2 w-2 h-2 translate-x-1/2 -translate-y-1/2 rounded-full bg-white dark:bg-main dark:group-hover:scale-150 dark:shadow-glow  transition-all duration-750"></span>
        <span className="group-hover:animate-ball-ping dark:group-hover:animate-none absolute top-1/2 start-1/2 w-2 h-2 translate-x-1/2 -translate-y-1/2 rounded-full bg-secondary -z-10"></span>
      </span>
      <div
