const HistoryCard = () => {
  return (
    <div className="group relative">
      ...
      <div className="relative ms-8 p-6 bg-matte shadow-4xl h-auto w-auto before:absolute before:top-3 before:start-0 before:w-3 before:h-3 before:rotate-45 before:bg-matte before:translate-x-1/2 before:transition-all before:duration-750 transition-all duration-750">
